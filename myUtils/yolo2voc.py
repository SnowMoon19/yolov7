...
if __name__ == '__main__':
    ...
    parser.add_argument('-ap', '--anno-path', type=str, default=r'D:\fxj\data\yolo2\test\labels', help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default=r'D:\fxj\projects\centernet\centernet-pytorch\VOCdevkit\multi\Annotations', help='xml save path')
    parser.add_argument('--image-path', default=r'D:\fxj\data\yolo2\test\images')
