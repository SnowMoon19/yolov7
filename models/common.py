...
class Detections:
    ...
    def save(self, save_dir='runs/hub/yolov7-c3hb-4-cot-multi1'):
        save_dir = increment_path(save_dir, exist_ok=save_dir != 'runs/hub/yolov7-c3hb-4-cot-multi1')  # increment save_dir
